...
var _httpStepsPng = require("./assets/img/HTTP_Steps.png");
var _httpStepsPngDefault = parcelHelpers.interopDefault(_httpStepsPng);
function App() {
    //   console.log(image01);
    console.log("F8");
  ...
  <h1>H\u{1ECD}c JS kh\xf4ng kh\xf3</h1>
  <h2>Th\u{1EDD}i gian hi\u{1EC7}n t\u{1EA1}i: ${(0, _momentDefault.default)().format("DD/MM/YYYY hh:mm:ss")}</h2>
  <h2>Server: ${(0, _configJsonDefault.default).SERVER_API}</h2>
  <img src="${0, _httpStepsPngDefault.default}"/>
  `;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Components/Header":"fNIx6","moment":"jwcsj","./assets/style.scss":"ll5JQ","./config.json":"8VeYg","./assets/img/HTTP_Steps.png":"kLwdY"}],"gkKU3":[function(require,module,exports) {
...
},{}],"ll5JQ":[function() {},{}],"8VeYg":[function(require,module,exports) {
module.exports = JSON.parse('{"SERVER_API":"http://localhost:8080"}');

},{}],"kLwdY":[function(require,module,exports) {
module.exports = require("a5c9dfd584d15a8").getBundleURL("UckoE") + "HTTP_Steps.61a943cf.png" + "?" + Date.now();

},{"a5c9dfd584d15a8":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequire2115")
